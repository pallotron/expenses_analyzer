...
class TestSoftDelete(unittest.TestCase):
    ...
    def test_new_transactions_have_deleted_false(self) -> None:
        ...
        with patch("expenses.data_handler.TRANSACTIONS_FILE", self.transactions_file), \
            ...
            assert loaded.iloc[0]["Deleted"] == False
    ...
    def test_load_filters_deleted_by_default(self) -> None:
        ...
        with patch("expenses.data_handler.TRANSACTIONS_FILE", self.transactions_file), \
            ...
            assert all_trans.iloc[0]["Deleted"] == True
    ...
    def test_multiple_deletes(self) -> None:
        ...
        with patch("expenses.data_handler.TRANSACTIONS_FILE", self.transactions_file), \
            ...
            # Delete 3 of them
            to_delete = pd.DataFrame({
                "Date": [datetime(2025, 1, 1), datetime(2025, 1, 3), datetime(2025, 1, 5)],
    ...
    def test_restore_deleted_transaction(self) -> None:
        ...
        with patch("expenses.data_handler.TRANSACTIONS_FILE", self.transactions_file), \
            ...
            assert active.iloc[0]["Deleted"] == False
